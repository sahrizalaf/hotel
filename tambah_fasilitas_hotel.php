        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Tambah Fasilitas Hotel</h1>

                    <div class="card shadow p-4">
                        <form action="proses_tambah_fasilitas_hotel.php" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="keterangan" class="form-control" placeholder="Tuliskan keterangan fasilitas hotel"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
