...
<head>
    ...
    <title>Data Kamar - BlueDoorz</title>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $hasil['fasilitas_kamar']; ?></td>
                                    <td><?php echo $hasil['jumlah_kamar']; ?></td>
                                    <td>
                                        <a href="edit_kamar.php?id=<?php echo $hasil['id_kamar']; ?>" class="btn btn-primary">Edit</a>
                                        <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?');" href="proses_hapus_kamar.php?id=<?php echo $hasil['id_kamar']; ?>" class="btn btn-danger">Hapus</a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                            </tbody>
