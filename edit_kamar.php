                    ...
                    <div class="card shadow p-4">
                        <form action="proses_edit_kamar.php" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="tipe_kamar" class="form-control" placeholder="Masukkan nama tipe kamar"  value="<?php echo $hasil['tipe_kamar']; ?>" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Fasilitas Kamar</label>
                                <div class="col-sm-10">
                                    <textarea name="fasilitas_kamar" class="form-control" placeholder="Tuliskan fasilitas kamar"><?php echo $hasil['fasilitas_kamar']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Jumlah Kamar</label>
                                <div class="col-sm-10">
                                    <input type="number" name="jumlah_kamar" class="form-control" placeholder="Masukkan jumlah kamar yang tersedia" value="<?php echo $hasil['jumlah_kamar']; ?>" >
                                </div>
                            </div>
                            <div class="form-group row">
